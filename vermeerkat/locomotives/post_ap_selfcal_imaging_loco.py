        ...
        recipe.add("cab/wsclean", "wsclean_SC1_0_%d" % target_field,
                   {
                       ...
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc1_0.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC1_1_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc1_1.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC1_2_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc1_2.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC1_3_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc1_3.taper_gaussian),

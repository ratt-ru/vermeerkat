        ...
        recipe.add("cab/wsclean", "wsclean_image_1gc_0_%d" % field_index[target.name],
                   {
                       ...
                       "npix": cfg.obs.im_npix_padded,
                       "trim" : cfg.obs.im_npix,
                       "cellsize": cfg.obs.angular_resolution,
                       ...
                       "field": target_field,
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_1gc_0.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_image_1gc_1_%d" % field_index[target.name],
                   {
                       ...
                       "field": target_field,
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_1gc_1.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_image_1gc_2_%d" % field_index[target.name],
               {
                   ...
                   "field": target_field,
                   "name": imname_prefix,
                   "taper-gaussian": dismissable(cfg.wsclean_image_1gc_2.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_image_1gc_3_%d" % field_index[target.name],
               {
                   ...
                   "field": target_field,
                   "name": imname_prefix,
                   "taper-gaussian": dismissable(cfg.wsclean_image_1gc_3.taper_gaussian),

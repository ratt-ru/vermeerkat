        ...
        recipe.add("cab/wsclean", "wsclean_SC0_0_%d" % target_field,
                   {
                       ...
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc0_0.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC0_1_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc0_1.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC0_2_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc0_2.taper_gaussian),
        ...
        recipe.add("cab/wsclean", "wsclean_SC0_3_%d" % target_field,
                   {
                       ...
                       "field": str(target_field),
                       "name": imname_prefix,
                       "taper-gaussian": dismissable(cfg.wsclean_image_sc0_3.taper_gaussian),
